...
-- This file is loaded after migrations during `indobase db reset`

-- Insert test users into auth.users
-- Note: Indobase CLI's auth schema has more columns than the old Docker setup
