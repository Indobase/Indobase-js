...
// removed IndobaseClient alias to avoid legacy naming
...
if (shouldShowDeprecationWarning()) {
  console.warn(
    `⚠️  Node.js 18 and below are deprecated and will no longer be supported in future versions of @indobase/indobase-js. ` +
