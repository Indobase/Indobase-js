...
const { corsHeaders } = require('@indobase/indobase-js/cors')

console.log('Testing @indobase/indobase-js/cors CommonJS exports...')
...
// Test 2: Verify all critical Indobase headers are present
...
console.log('✓ All required Indobase headers are present')
...
console.log('\n✅ All CommonJS module resolution tests passed for @indobase/indobase-js/cors')
