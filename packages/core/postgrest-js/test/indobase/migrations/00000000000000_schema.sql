...
ALTER TABLE public.users REPLICA IDENTITY FULL; -- Send "previous data" to indobase
...
ALTER TABLE public.channels REPLICA IDENTITY FULL; -- Send "previous data" to indobase
...
ALTER TABLE public.messages REPLICA IDENTITY FULL; -- Send "previous data" to indobase
...
ALTER TABLE public.collections REPLICA IDENTITY FULL; -- Send "previous data" to indobase
...
-- Extensions schema already exists in Indobase CLI
...
create table booking (
  id bigint generated by default as identity primary key,
  hotel_id bigint, -- nullable foreign key is needed to reproduce !inner indobase-js error
